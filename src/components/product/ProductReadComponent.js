...
const ProductReadComponent = () => {
    return (
        <section className="flex items-center justify-center min-h-screen py-16 px-8">
            <div className="container grid place-items-center grid-cols-1 md:grid-cols-2 gap-8">
                <img
